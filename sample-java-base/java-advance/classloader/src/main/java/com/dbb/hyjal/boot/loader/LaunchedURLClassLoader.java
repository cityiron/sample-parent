...
import com.dbb.hyjal.boot.loader.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
     ...
     * @param classLoader
     */
    public void addThisToParentClassLoader(ClassLoader classLoader) throws Exception {
        // 破坏双亲委派模型
    ...
    private void clearCache(URLConnection connection) throws IOException {
        ...
        if (jarFile instanceof com.dbb.hyjal.boot.loader.jar.JarFile) {
            ((com.dbb.hyjal.boot.loader.jar.JarFile)jarFile).clearCache();
        }
    }
